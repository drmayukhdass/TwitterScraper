...
def train_bert_model(train_df, model_name):
    ...
    train_dataset = TensorDataset(train_encodings['input_ids'], train_encodings['attention_mask'], torch.tensor(train_df['intent_encoded'].values))
...
def evaluate_saved_bert_model(test_df,model_name):
    ...
    test_dataset = TensorDataset(test_encodings['input_ids'], test_encodings['attention_mask'], torch.tensor(test_df['intent_encoded'].values))
