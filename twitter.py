...
def retrieve_tweets(bearer_token, search_str, num_tweets):
    try:
        ...
        tweets = client.search_recent_tweets(query=search_str, max_results=num_tweets)
        return tweets
    except Exception as e:
        st.error(f"Error occurred during tweet retrieval: {str(e)}")
        return None
...
def main():
    ...
    num_tweets = st.number_input("Enter number of tweets to retrieve:", min_value=1, max_value=100, step=1, value=10)
